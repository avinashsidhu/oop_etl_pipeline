...
class IntTestETLMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.s3_bucket_name_src = 'test-src-etlproject'
        self.s3_bucket_name_trg = 'test-trg-etlproject'
    ...
    def test_int_etl_report1_no_metafile(self):
        ...
        # Method execution
        xetra_etl = ETL(self.s3_bucket_src, self.s3_bucket_trg,
